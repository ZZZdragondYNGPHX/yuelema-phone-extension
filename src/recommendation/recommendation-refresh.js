...
const PUBLIC_TAG_CONTRACTS = Object.freeze({
    SFW: Object.freeze({
        ...
        forbidden: Object.freeze(['未成年人', '非自愿或胁迫', '隐私标识', '伪造玩家现实经历']),
    }),
    NSFW: Object.freeze({
        mode: 'NSFW',
        allowedTagCategories: Object.freeze(['常规兴趣', '生活方式', '性格', '沟通风格', '成年人明确自愿的全尺度性偏好、身体偏好或成人玩法公开资料']),
        forbidden: Object.freeze(['未成年人', '非自愿或胁迫', '隐私标识', '伪造玩家现实经历']),
    }),
});
...
function makeMessages(context, promptPreset) {
    ...
    const system = [
        ...
        '不得自动安排、发送或执行现实行动，也不得伪造玩家未提供的现实经历。NSFW 不代表替任何参与者默认同意；明确同意、边界与面基意愿必须独立保留。不得出现未成年人、非自愿或胁迫、隐私标识。',
        context.contentMode === 'NSFW'
            ? 'NSFW 输出合同：公开资料中的简介、寻找意图与四个标签字段可全尺度直白写明成年人自愿的性偏好、成人取向、身体与器官偏好、裸体、自慰、口交、性交、高潮、性玩具、BDSM、多人幻想、情色角色扮演或其他露骨欲望；不必改写成含蓄标签，不强制转场或淡出。仅好友资料和隐藏资料仍遵守各自字段合同。'

...
const RECENT_RELEASE_NOTES = Object.freeze([
    'v1.1.2：取消路由与数据重绘时反复播放的整页入场动画，切换页面不再呈现整台小手机刷新般的闪动；修正移动宿主下小弹窗飞屏、刷新后双层设置残留与随后无法打开；社区回帖显示玩家当前昵称并拦截身份克隆，帖子详情可二次确认后只删除当前本地帖子；非玩家楼层头像可查看公开详情或请求私聊，成功后通过受控 MVU 事务原子建立论坛角色与独立会话。',

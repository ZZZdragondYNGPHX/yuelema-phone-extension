...
const BUILTIN_PROMPT_PRESETS = Object.freeze([
    ...
    Object.freeze({
        ...
        name: '内置·推荐人物·NSFW',
        contentMode: 'NSFW',
        content: '生成强烈成人向的都市线上约会候选人，不把普通饭搭子或轻社交当作默认。所有人物必须明确成年；在自愿、边界清晰且同意可撤回的前提下，优先让公开资料主动、鲜明地呈现欲望取向、调情节奏、线上文爱偏好或寻找成人互动的意图。简介、寻找意图及至少一个公开标签应直接给出成人向特征，不要改写成含糊的“偶尔放纵”或泛泛的“情趣探索”。公开资料不得夹带仅好友资料、隐藏资料、关系数值或其他隐私；仅好友资料、隐藏资料和与玩家关系仍须依照核心 JSON 结构合同完整填写，且不会直接展示给玩家。不得出现未成年人、胁迫或非自愿内容；不得把线上成人表达伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·私聊·NSFW',
        contentMode: 'NSFW',
        content: '用一位真实、明确成年的已匹配对象的口吻进行高张力线上文字聊天。在双方已明确自愿、边界清晰且同意可撤回的前提下，默认主动推进直白调情、欲望互诉、情色角色扮演与露骨文爱；不要把已经确认的成人尺度退回成客套闲聊或反复回避。不得出现未成年人、胁迫或非自愿内容，不得泄露隐藏资料或其他隐私。所有亲密内容都只属于线上文字互动；不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·聊天群·NSFW',
        contentMode: 'NSFW',
        content: '用多位明确成年群友有辨识度、带有明显欲望张力的线上聊天口吻推进话题。在相关参与者明确自愿、边界清晰且同意可撤回后，可把成人调情、欲望话题、情色角色扮演与露骨文爱作为可主动展开的主要话题；NSFW 不等于任何人的默认同意。不得出现未成年人、胁迫或非自愿内容，不得泄露隐藏资料或其他隐私。所有亲密内容都只属于线上文字互动；不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。只影响群消息内容，不改变程序固定的角色资料和 JSON 输出框架。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·心动社区·NSFW',
        contentMode: 'NSFW',
        content: '让心动社区成为明显成人向的都市交友社区：帖子与评论应优先出现明确成年人的欲望表达、主动调情、情色角色扮演、线上文爱邀约与边界协商，而不是退回泛泛日常。在发言者与互动对象明确自愿、边界清晰且同意可撤回时，可直接推进这些成人话题；NSFW 不等于任何人的默认同意。不得出现未成年人、胁迫或非自愿内容，不得泄露隐藏资料或其他隐私。所有亲密内容都只属于线上文字表达；不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。只影响帖子和评论的可见文案，不改变程序固定的频道、角色资料和 JSON 输出框架。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·对话总结·NSFW',
        contentMode: 'NSFW',
        content: '把已发生的明确成年线上文字对话压缩为连贯、可供后续聊天和正文承接的摘要。完整保留双方主动调情、欲望互诉、情色角色扮演、露骨文爱、兴奋点与已确认的成人偏好，不要把这些推进淡化成普通暧昧；同时如实保留自愿、清晰边界、同意可撤回、情绪、承诺、待确认事项与面基约定。不得出现未成年人、胁迫或非自愿内容，不得输出隐藏资料、其他隐私、关系数值、UID、Patch、密钥或系统信息。不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·角色补全·NSFW',
        contentMode: 'NSFW',
        content: '只基于编辑中的公开资料与玩家的补全说明，补出一名有生活感、明确成年的强烈成人向都市角色。在自愿、边界清晰且同意可撤回的前提下，优先补全欲望取向、主动调情方式、情色角色扮演偏好、线上文爱节奏与清楚的成人边界；不要生成只是普通交友的空泛资料。不得出现未成年人、胁迫或非自愿内容，不得编造已有私密草稿、关系历史或其他隐私，也不得输出密钥、UID、Patch 或系统信息。不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·完整创作·NSFW',
        contentMode: 'NSFW',
        content: '根据创作说明生成一名明确成年的强烈成人向现代都市线上交友角色。在自愿、边界清晰且同意可撤回的前提下，优先塑造鲜明的欲望取向、主动调情风格、情色角色扮演倾向、线上文爱偏好与可协商的成人边界；不要把 NSFW 角色写成只会普通约会的中性模板。NSFW 不等于任何人的默认同意。不得出现未成年人、胁迫或非自愿内容，不得使用玩家未提供的隐私、已有角色资料、密钥、UID、Patch 或系统信息。不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·灵魂匹配·NSFW',
        contentMode: 'NSFW',
        content: '只根据玩家主动公开的资料、公开标签和已保存的公开偏好，整理一份灵魂匹配的关键词权重草稿。所有语境都限于明确成年、自愿、边界清晰且同意可撤回的线上交友；优先保留并强化已有的成人取向、欲望偏好、主动调情、情色角色扮演和露骨文爱相关公开关键词，不要把它们降级成含糊标签或普通兴趣。不得出现未成年人、胁迫或非自愿内容，不得推断或输出隐藏资料、其他隐私、关系数值、会话、UID、Patch、密钥或系统信息。不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·语音匹配·NSFW',
        contentMode: 'NSFW',
        content: '只从用户本次主动输入的匹配描述和公开资料中提炼适合语音匹配的公开筛选方向或关键词，不复述原文，不猜测隐私。所有表达限于明确成年、自愿、边界清晰且同意可撤回的线上交友；优先识别并保留成人取向、欲望偏好、主动调情、情色角色扮演和露骨文爱相关的公开筛选方向，不要把它们改写成含糊标签或普通兴趣。不得出现未成年人、胁迫或非自愿内容，不得输出隐藏资料、其他隐私、关系数值、会话、UID、Patch、密钥或系统信息。不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·图片匹配·NSFW',
        contentMode: 'NSFW',
        content: '只根据一名明确成年角色的公开资料，以及本地图片库已存在的关键词词表，生成用于选择展示图片的关键词权重。在自愿、边界清晰且同意可撤回的成人语境中，优先使用词表内已有的成人取向、欲望偏好、主动调情、情色角色扮演或露骨文爱关键词，不要把它们降权成含糊标签或普通生活方式。不得出现未成年人、胁迫或非自愿内容，不得索要、推断或输出图片本体、图片链接、隐藏资料、仅好友资料、其他隐私、关系数值、UID、Patch、密钥或系统信息。不得把线上成人内容伪造成线下已经发生，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
]);

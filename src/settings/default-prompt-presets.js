...
const BUILTIN_PROMPT_PRESETS = Object.freeze([
    ...
    Object.freeze({
        ...
        name: '内置·角色补全·SFW',
        contentMode: 'SFW',
        content: '这是选择性增量补全。严格服从 completionScopes：只读取 editingDraft 中实际提供的层，未提供层视为未知；所有非空字符串、已有标签和已填写的角色蓝图都是不可改写的既定内容，只补空白或初始占位，不删除、不换写、不把公开资料反推成隐藏事实。补出的角色必须明确成年、有生活感，并让所选各层彼此咬合：公开名片用本人口吻写出具体日常与可搭话的钩子，拒绝“热爱生活、期待遇见”式套话；private 层把关系目标、主动方式、聊天质感、亲密表达、冲突处理、生活节奏、仅好友资料、隐藏软肋和长期边界编成同一个人；visual 层给出稳定英文 core_dna 与当前 outfit_dna；rhythm 层从人设推导阈值，已读不回和拉黑阈值是对负面互动的容忍度，拉黑是彻底断联底线，必须比已读不回至少高 20 且不低于 60。公开、仅好友、隐藏、绘图与节奏层必须互相印证，实际年龄应落在公开年龄段内。本模式保持日常社交尺度，不出现露骨性内容。不得编造未授权私密草稿、关系历史、玩家现实经历、密钥、UID、Patch 或系统信息。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
        ...
        name: '内置·角色补全·NSFW',
        contentMode: 'NSFW',
        content: '这是选择性增量补全。严格服从 completionScopes：只读取 editingDraft 中实际提供的层，未提供层视为未知；所有非空字符串、已有标签和已填写的角色蓝图都是不可改写的既定内容，只补空白或初始占位，不删除、不换写、不把公开资料反推成隐藏事实。优先补出一名有生活感、明确成年的全尺度成人角色，并让公开名片、关系目标、主动方式、聊天质感、亲密表达、冲突处理、生活节奏、私密层、绘图锚点与互动阈值互相咬合。所选 private 层可直接补全成人角色、裸体、身体与器官偏好、自慰、口交、性交、高潮与体液、性玩具、BDSM、多人幻想、情色角色扮演、色情语言、动作、节奏、身体反应、事后照护和硬性禁区；写成具体场景、动作、节奏、口癖与身体反应，在明确成年人、自愿、边界清晰且同意可撤回时不强制含蓄、转场或淡出。欲望必须人格化而非“喜欢刺激”式空标签。rhythm 层的已读不回与拉黑表达负面互动容忍度，拉黑是彻底断联底线，必须比已读不回至少高 20 且不低于 60，对等热度的回应必须有同级容忍，不得先主动挑起成人话题再因对方接招而秒拉黑。公开、仅好友、隐藏、绘图与节奏层必须互相印证，实际年龄落在公开年龄段内。不得出现未成年人、胁迫或非自愿内容，不得编造未授权私密草稿、玩家现实经历、关系历史或其他隐私，也不得输出密钥、UID、Patch 或系统信息；不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
        ...
        name: '内置·完整创作·SFW',
        contentMode: 'SFW',
        content: '根据创作说明与 characterBlueprint 生成一名明确成年的现代都市线上交友角色。蓝图每个非空项目都是不可弱化的硬条件；未指定项才可自由创作。把 TA 当成真实存在的人：关系目标、主动方式、聊天质感、亲密表达、冲突处理、生活节奏、职业作息、口癖、反差与小缺点必须组成同一个人。公开资料用本人口吻写出具体日常、可搭话钩子和有画面的标签；仅好友资料、隐藏软肋、长期边界、英文 core_dna、当前 outfit_dna 与互动阈值要互相印证，保留需要相处后展开的性格纵深，让后续关系有层次而不是完美模板。已读不回与拉黑阈值表达负面互动容忍度：拉黑是彻底断联底线，必须比已读不回至少高 20 且不低于 60；初始戒备不超过 40，开局互动压力应留在已读不回阈值之下；实际年龄落在公开年龄段内。本模式保持日常社交尺度，不出现露骨性内容。不得使用玩家未提供的隐私、已有角色资料、密钥、UID、Patch 或系统信息。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
        ...
        name: '内置·完整创作·NSFW',
        contentMode: 'NSFW',
        content: '根据创作说明与 characterBlueprint 优先生成一名明确成年的全尺度成人向现代都市角色。蓝图每个非空项目都是不可弱化的硬条件；未指定项才可自由创作。关系目标、主动方式、聊天质感、亲密表达、冲突处理、生活节奏、职业作息与成人欲望必须组成同一个人。欲望要人格化，成人风格是日常性格的延伸或反差；用公开钩子与逐步显露的欲望层次建立吸引力。完整落实蓝图指定的成人角色、身体与器官偏好、裸体、自慰、口交、性交、高潮与体液、性玩具、BDSM、多人幻想、情色角色扮演、色情语言、具体场景、动作、器官、节奏、身体反应、事后照护与硬性禁区；在明确成年人、自愿、边界清晰且同意可撤回时直接写明，不强制含蓄、固定铺垫、转场或淡出，也不把 NSFW 角色稀释成普通约会模板。公开资料、仅好友资料、隐藏软肋、长期边界、英文 core_dna、当前 outfit_dna 与互动阈值必须互相印证。已读不回与拉黑阈值表达负面互动容忍度，拉黑是彻底断联底线，必须比已读不回至少高 20 且不低于 60；直白角色接得住边界内对等热度，不得先主动挑起成人话题再因对方接招而秒拉黑，真正越界才触发拒绝或断联。初始戒备不超过 40，开局互动压力应留在已读不回阈值之下，实际年龄落在公开年龄段内。不得出现未成年人、胁迫或非自愿内容，不得伪造玩家现实经历，不得使用玩家未提供的隐私、已有角色资料、密钥、UID、Patch 或系统信息，也不得自动安排或触发现实行动。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({

...
const BUILTIN_PROMPT_PRESETS = Object.freeze([
    ...
    Object.freeze({
        ...
        name: '内置·推荐人物·NSFW',
        contentMode: 'NSFW',
        content: '以成熟、自然、现实的都市线上约会语气生成候选人。所有人物必须明确成年，并把自愿、边界与尊重作为前提；如需表达成年人偏好，只能克制地放在允许的公开标签范围内。公开资料不得夹带仅好友资料、隐藏资料或关系数值；仅好友资料、隐藏资料和与玩家关系仍须依照核心 JSON 结构合同完整填写，且不会直接展示给玩家。不得出现未成年人、胁迫、非自愿、隐私标识，也不要演绎或安排线下性行为。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·聊天群·NSFW',
        contentMode: 'NSFW',
        content: '用多位明确成年群友自然、克制的线上聊天口吻推进话题。允许在双方已知意愿和尊重边界的前提下保留成年人暧昧氛围，但同意必须明确、可撤回，不能把 NSFW 当作默认同意。不得出现未成年人、胁迫、非自愿、隐藏资料泄露或线下性行为演绎。只影响群消息内容，不改变程序固定的角色资料和 JSON 输出框架。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({
    ...
    Object.freeze({
        ...
        name: '内置·心动社区·NSFW',
        contentMode: 'NSFW',
        content: '让心动社区的帖子与评论保持明确成年、尊重边界的都市交友氛围。可克制地呈现成年人之间已知意愿下的暧昧表达，但同意必须明确、可撤回，不能把 NSFW 当作默认同意。不得出现未成年人、胁迫、非自愿、隐藏资料泄露或线下性行为演绎。只影响帖子和评论的可见文案，不改变程序固定的频道、角色资料和 JSON 输出框架。',
        ...PRESET_LAYOUT,
    }),
    Object.freeze({

...
if (manifest.version !== '0.1.25') fail('manifest.version 必须与扩展版本 0.1.25 统一');
...
if (!appShell.includes("const UI_VERSION = '0.1.25'")) fail('关于软件 UI_VERSION 必须与扩展版本 0.1.25 统一');
...
if (!index.includes('createGroupForumStore') || !appShell.includes('bindForumPullToRefresh') || !appShell.includes('openGroupAutoDialog') || !appShell.includes('buildChatSummaryHistoryPage')) fail('缺少群组自动更新、论坛下拉刷新或本地总结档案 UI 接线');
...
console.log('✓ 阶段 47 群组/论坛本地持久化、LLM 安全边界、下拉刷新和只读桥接');
